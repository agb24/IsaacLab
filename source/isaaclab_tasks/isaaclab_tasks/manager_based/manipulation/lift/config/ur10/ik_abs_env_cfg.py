...
@configclass
class UR10TeddyBearLiftEnvCfg(UR10CubeLiftEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
        ...
        self.scene.robot.actuators["Robotiq_2F_140_config"].effort_limit = 50.0
        self.scene.robot.actuators["Robotiq_2F_140_config"].stiffness = 40.0
        self.scene.robot.actuators["Robotiq_2F_140_config"].damping = 10.0
