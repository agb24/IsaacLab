...
UR5e_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path="omniverse://localhost/Library/ur5e_rg2_articulation_isaaclab.usd",
...
UR5E_HIGH_PD_CFG.spawn.rigid_props.disable_gravity = False
UR5E_HIGH_PD_CFG.actuators["shoulder_pan_joint"].stiffness *= 10000
UR5E_HIGH_PD_CFG.actuators["shoulder_pan_joint"].damping *= 1000
UR5E_HIGH_PD_CFG.actuators["shoulder_lift_joint"].stiffness *= 10000
UR5E_HIGH_PD_CFG.actuators["shoulder_lift_joint"].damping *= 1000
UR5E_HIGH_PD_CFG.actuators["elbow_joint"].stiffness *= 10000
UR5E_HIGH_PD_CFG.actuators["elbow_joint"].damping *= 1000
UR5E_HIGH_PD_CFG.actuators["wrist_1_joint"].stiffness *= 7500
UR5E_HIGH_PD_CFG.actuators["wrist_1_joint"].damping *= 500
UR5E_HIGH_PD_CFG.actuators["wrist_2_joint"].stiffness *= 5000
UR5E_HIGH_PD_CFG.actuators["wrist_2_joint"].damping *= 250
UR5E_HIGH_PD_CFG.actuators["wrist_3_joint"].stiffness *= 5000
UR5E_HIGH_PD_CFG.actuators["wrist_3_joint"].damping *= 250
UR5E_HIGH_PD_CFG.actuators["rg2_gripper"].stiffness *= 1000 
UR5E_HIGH_PD_CFG.actuators["rg2_gripper"].damping *= 100
