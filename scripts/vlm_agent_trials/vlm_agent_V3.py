...
1. This will move to <<NUM>> positions, which are defined in the world frame. 
        TODO: Change this to base frame of the robot.
2. TODO: Add a CustomIK Solver written by Karishma for setup. 
...
def run_simulator(env: gym.Env):
    ...
    cartesian_utils = env.env.cartesian_ctrl
